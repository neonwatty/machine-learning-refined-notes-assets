...
class linear_regression_visualizer:
    ...
    def plot_fit(self, plotting_weights, **kwargs):
        ...
        # initialize points
        ax2.scatter(self.x, self.y, color="k", edgecolor="w", linewidth=0.9, s=40, zorder=0)
        ...
        ax2.set_ylabel(r"$y$", rotation=0, fontsize=12)
        ...
        for i in range(len(plotting_weights)):
            ...
            ax2.plot(s, t, linewidth=2, color=colors[i], zorder=3)
            # c+=1
